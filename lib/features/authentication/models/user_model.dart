...
class UserModel extends GetxController {
  /// Keep thoses values final which you do not want to update
  ...
  static String generateUsername(fullName) {
    ...
    String firstName = nameParts[0].toLowerCase(),
        lastName = nameParts.length > 1 ? nameParts[1].toLowerCase() : '',
        camelCaseUsername = '$firstName$lastName', //Combine first and last name
        usernameWithPrefix = 'cwt_$camelCaseUsername'; // Add 'cwt_' prefix
